...
class dmFactoryConfigHandler extends sfFactoryConfigHandler
{
  ...
  public function execute($configFiles)
  {
    ...
    $factories = array('view_cache_manager', 'logger', 'module_manager', 'i18n', 'controller', 'request', 'response', 'routing', 'storage', 'user', 'view_cache', 'mailer');
    ...
    foreach ($factories as $factory)
    {
      ...
      switch ($factory)
      {
        ...
        case 'module_manager':
          ...
          $instances[] = sprintf("  \$class = sfConfig::get('sf_factory_module_manager', '%s');\n".
                           "\$this->factories['module_manager'] = new \$class(sfConfig::get('sf_factory_module_manager_parameters', %s));\n",
