...
class dmForm extends sfFormSymfony
{
  ...
  public static function getFormEmbedder(sfForm $form)
  {
	...
	{
		return isset($this->options['widgets']) && ( in_array($name, $this->options['widgets']) || in_array($name.'_form', $this->options['widgets']) || in_array($name.'_view', $this->options['widgets']));
	}
}