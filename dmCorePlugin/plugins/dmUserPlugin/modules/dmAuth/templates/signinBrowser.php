...
echo _tag('div.message',
  _tag('p.dm_browser_unsupported.mt10', "Sorry, it looks like you're using a browser that isn't supported.").
  _tag('p.dm_browser_suggestion.mt10', "We suggest that you use one of these browsers:").
  ...
  _tag('div.dm_skip_browser_detection',
    _link('+/dmAuth/signin?skip_browser_detection=1')->text(__('Or continue at your own peril'))
  )
);
