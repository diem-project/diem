...
/**
 * CommentVersion filter form base class.
 *
 * @package    retest
 * @subpackage filter
 ...
 */
abstract class BaseCommentVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('comment_version_filters[%s]');
