...
echo _open('div#dm_console.mt10');
  echo _open('ul#dm_lines');
    echo _tag("li.dm_command_intro", sprintf("Logged as %s on %s", $whoami, $uname));
    echo _tag("li.dm_command_intro", str_repeat("-", 20));
    echo _tag("li.dm_command_intro", "Current working directory: ".$pwd);
    echo _tag("li.dm_command_intro", "Commands Available:");
    echo _tag("li.dm_command_intro", "<strong>".$commands."</strong>");
    echo _tag("li.dm_command_intro", "symfony commands can be run by prefixing with sf<br />Exemple : sf cc (clear cache)");
    echo _tag("li.dm_command_intro", str_repeat("-", 20));
  echo _close('ul');
